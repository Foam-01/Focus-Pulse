...
const HEADER_TITLES: Record<ActiveView, { title: string; sub: string }> = {
  ...
  alarmView: {
    title: 'นาฬิกาปลุก',
    sub: 'ตั้งเวลาปลุกตามเวลาจริงพร้อมการแจ้งเตือนแบบเตือนซ้ำ',
  },
  stopwatchView: {
    title: 'จับเวลาเดินหน้า',
    sub: 'จับเวลาแบบแม่นยำระดับมิลลิวินาทีพร้อมระบบบันทึกเวลาต่อรอบ',
  },
  worldClockView: {
    title: 'เวลาโลก',
    sub: 'ดูเวลาจริงของเมืองสำคัญทั่วโลกและเปรียบเทียบความต่างของเวลา',
  },
  videoLibraryView: {
